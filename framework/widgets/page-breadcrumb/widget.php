...
class Widget___NAMESPACE__PageBreadcrumb extends Widget_Base
{
	...
	{
		return __('Page Breadcrumb', '__TEXT_DOMAIN__');
	}
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->add_control(
			'text_color_hover',
			[
				'label' => __('Text Color Hover', '__TEXT_DOMAIN__'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bt-page-breadcrumb' => 'color: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Text Typography', '__TEXT_DOMAIN__'),
				'default' => '',
...
?>
		<div class="bt-elwg-page-breadcrumb">
			<div class="bt-page-breadcrumb">
				<?php
				$home_text = esc_html__('Home', '__TEXT_DOMAIN__');
				$delimiter = '/';
