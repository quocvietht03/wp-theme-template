<?php
function __THEME_SLUG_FLAT___register_layout_category($categories)
{
...
add_filter('block_categories_all', '__THEME_SLUG_FLAT___register_layout_category');

function __THEME_SLUG_FLAT___acf_init()
{
    ...
    if (function_exists('acf_register_block')) {
        acf_register_block(array(
            ...
            'render_callback'   => '__THEME_SLUG_FLAT___acf_block_render_callback',
            // 'enqueue_assets' => '__THEME_SLUG_FLAT___acf_block_assets_callback',
...
add_action('acf/init', '__THEME_SLUG_FLAT___acf_init');

function __THEME_SLUG_FLAT___acf_block_render_callback($block)
{
...
function __THEME_SLUG_FLAT___acf_block_assets_callback($block)
{
