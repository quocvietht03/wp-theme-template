<?php
/* Count post view. */
if (!function_exists('__THEME_SLUG_FLAT___set_count_view')) {
  function __THEME_SLUG_FLAT___set_count_view()
  {
    $post_id = get_the_ID();

    if (is_single() && !empty($post_id) && !isset($_COOKIE['__THEME_SLUG_FLAT___post_view_' . $post_id])) {
      ...
      /* set cookie. */
      setcookie('__THEME_SLUG_FLAT___post_view_' . $post_id, $post_id, time() * 20, '/');
    }
  }
}
add_action('wp', '__THEME_SLUG_FLAT___set_count_view');

/* Post count view */
if (!function_exists('__THEME_SLUG_FLAT___get_count_view')) {
  function __THEME_SLUG_FLAT___get_count_view()
  {
    $post_id = get_the_ID();
    $views = get_post_meta($post_id, '_post_count_views', true);
...
/* Post Reading */
if (!function_exists('__THEME_SLUG_FLAT___reading_time_render')) {
  function __THEME_SLUG_FLAT___reading_time_render()
  {
...
/* Single Post Title */
if (!function_exists('__THEME_SLUG_FLAT___single_post_title_render')) {
  function __THEME_SLUG_FLAT___single_post_title_render()
  {
    ob_start();
?>
...
/* Post Title */
if (!function_exists('__THEME_SLUG_FLAT___post_title_render')) {
  function __THEME_SLUG_FLAT___post_title_render()
  {
    ob_start();
  ?>
    <h3 class="bt-post--title">
...
/* Post Featured */
if (!function_exists('__THEME_SLUG_FLAT___post_featured_render')) {
  function __THEME_SLUG_FLAT___post_featured_render($image_size = 'full')
  {
    ob_start();
...
/* Post Cover Featured */
if (!function_exists('__THEME_SLUG_FLAT___post_cover_featured_render')) {
  function __THEME_SLUG_FLAT___post_cover_featured_render($image_size = 'full')
  {
    ob_start();
    ?>
    <div class="bt-post--featured">
...
/* Post Publish */
if (!function_exists('__THEME_SLUG_FLAT___post_publish_render')) {
  function __THEME_SLUG_FLAT___post_publish_render($format = null)
  {
    ob_start();
    if ($format) {
...
/* Post Short Meta */
if (!function_exists('__THEME_SLUG_FLAT___post_short_meta_render')) {
  function __THEME_SLUG_FLAT___post_short_meta_render()
  {
    ob_start();
  ...
  ?>
    <div class="bt-post--meta">
      ...
      echo __THEME_SLUG_FLAT___reading_time_render();
      ?>
    </div>
  <?php
...
/* Post Meta */
if (!function_exists('__THEME_SLUG_FLAT___post_meta_render')) {
  function __THEME_SLUG_FLAT___post_meta_render()
  {
    ob_start();
    $post_id = get_the_ID();
...
if (!function_exists('__THEME_SLUG_FLAT___post_meta_single_render')) {
  function __THEME_SLUG_FLAT___post_meta_single_render()
  {
    ob_start();
...
/* Post Category */
if (!function_exists('__THEME_SLUG_FLAT___post_category_render')) {
  function __THEME_SLUG_FLAT___post_category_render()
  {
    $post_id = get_the_ID();
...
/* Post Excerpt */
if (!function_exists('__THEME_SLUG_FLAT___post_excerpt_render')) {
  function __THEME_SLUG_FLAT___post_excerpt_render()
  {
    ob_start();
    ?>
...
/* Post Content */
if (!function_exists('__THEME_SLUG_FLAT___post_content_render')) {
  function __THEME_SLUG_FLAT___post_content_render()
  {
    ob_start();
    if (is_single()) {
    ?>
...
/* Post tag */
if (!function_exists('__THEME_SLUG_FLAT___tags_render')) {
  function __THEME_SLUG_FLAT___tags_render()
  {
    ob_start();
    if (has_tag()) {
    ?>
...
/* Post share */
if (!function_exists('__THEME_SLUG_FLAT___share_render')) {
  function __THEME_SLUG_FLAT___share_render()
  {
...
/* Post Button */
if (!function_exists('__THEME_SLUG_FLAT___post_button_render')) {
  function __THEME_SLUG_FLAT___post_button_render($text)
  { ?>
...
/* Author Icon */
if (!function_exists('__THEME_SLUG_FLAT___author_icon_render')) {
  function __THEME_SLUG_FLAT___author_icon_render()
  { ?>
...
/* Author with avatar */
if (!function_exists('__THEME_SLUG_FLAT___author_w_avatar')) {
  function __THEME_SLUG_FLAT___author_w_avatar()
  {
...
/* Author */
if (!function_exists('__THEME_SLUG_FLAT___author_render')) {
  function __THEME_SLUG_FLAT___author_render()
  {
    $author_id = get_the_author_meta('ID');
...
/* Related posts */
if (!function_exists('__THEME_SLUG_FLAT___related_posts')) {
  function __THEME_SLUG_FLAT___related_posts()
  {
    if (function_exists('get_field')) {
...
//Comment Field Order
function __THEME_SLUG_FLAT___comment_fields_custom_order($fields)
{
...
add_filter('comment_form_fields', '__THEME_SLUG_FLAT___comment_fields_custom_order');

/* Custom comment list */
if (!function_exists('__THEME_SLUG_FLAT___custom_comment')) {
  function __THEME_SLUG_FLAT___custom_comment($comment, $args, $depth)
  {
