...
if (! function_exists('__THEME_SLUG_FLAT___setup')) {
	function __THEME_SLUG_FLAT___setup()
	{
		/* Load textdomain */
		...
		add_theme_support('custom-background', apply_filters('__THEME_SLUG_FLAT___custom_background_args', array(
			'default-color' => 'f5f5f5',
		)));

		/* Add support for featured content. */
		add_theme_support('featured-content', array(
			'featured_content_filter' => '__THEME_SLUG_FLAT___get_featured_posts',
			'max_posts' => 6,
		));
	}
}
add_action('after_setup_theme', '__THEME_SLUG_FLAT___setup');
...
/* Nav Menu */
if (!function_exists('__THEME_SLUG_FLAT___nav_menu')) {
	function __THEME_SLUG_FLAT___nav_menu($menu_slug = '', $theme_location = '', $container_class = '')
	{
...
/* Page title */
if (!function_exists('__THEME_SLUG_FLAT___page_title')) {
	function __THEME_SLUG_FLAT___page_title()
	{
		ob_start();
		if (is_front_page()) {
...
/* Page breadcrumb */
if (!function_exists('__THEME_SLUG_FLAT___page_breadcrumb')) {
	function __THEME_SLUG_FLAT___page_breadcrumb($home_text = 'Home', $delimiter = '-')
	{
		global $post;
...
if (! function_exists('__THEME_SLUG_FLAT___post_nav')) {
	function __THEME_SLUG_FLAT___post_nav()
	{
...
if (! function_exists('__THEME_SLUG_FLAT___paginate_links')) {
	function __THEME_SLUG_FLAT___paginate_links($wp_query)
	{
...
if (! function_exists('__THEME_SLUG_FLAT___paging_nav')) {
	function __THEME_SLUG_FLAT___paging_nav()
	{
 ...
 */
if (!function_exists('__THEME_SLUG_FLAT___back_to_top')) {
	function __THEME_SLUG_FLAT___back_to_top()
	{
	?>
...
add_action('wp_footer', '__THEME_SLUG_FLAT___back_to_top', 99);
