<?php
/* Register Sidebar */
if (!function_exists('__THEME_SLUG_FLAT___register_sidebar')) {
	function __THEME_SLUG_FLAT___register_sidebar()
	{
	...
	add_action('widgets_init', '__THEME_SLUG_FLAT___register_sidebar');
}

/* Get icon SVG HTML */
function __THEME_SLUG_FLAT___get_icon_svg_html( $icon_file_name ) {
...
/* Enqueue Script */
if (!function_exists('__THEME_SLUG_FLAT___enqueue_scripts')) {
	function __THEME_SLUG_FLAT___enqueue_scripts()
	{
	...
	add_action('wp_enqueue_scripts', '__THEME_SLUG_FLAT___enqueue_scripts');
}
/* Add Stylesheet And Script Backend */
if (!function_exists('__THEME_SLUG_FLAT___enqueue_admin_scripts')) {
	function __THEME_SLUG_FLAT___enqueue_admin_scripts($hook)
	{
		wp_enqueue_style('__THEME_SLUG__-fonts', get_template_directory_uri() . '/assets/css/fonts.css',  array(), false);
	...
	add_action('admin_enqueue_scripts', '__THEME_SLUG_FLAT___enqueue_admin_scripts');
}
